...
+ [Tidak, pak]
  Oke baiklah, nak. Ingat kalau berenang bisa membuatmu sehat seperti bapak. HAHAHAHA. # speaker: Instruktur
  h-hahaha. # speaker: {player} #score: 0 #stress: 0
  {player} tertawa canggung # speaker: narrator #score: 0 #stress: 0
  ->DONE
+ [Iya, pak]
  Baiklah. Bapak akan mengajarkan teknik - teknik dasar berenang. # speaker: Instruktur
  ...
  {player} hanya tersenyum. # speaker: narrator #score: 100 #stress: 5
  ->DONE
    -> END
