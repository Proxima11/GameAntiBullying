...
+melaporkan
    ...
    {player} dan {David} bertengkar fisik. Lalu karena kalah jumlah {player} babak belur. Setelah memukuli {player}, {David} dan geng nya meninggalkan tempat secara buru-buru karena takut bertemu guru.#speaker:narrator #score: 0 #stress: 0
+ tidak melaporkan
    ++ Memberikan {jajan} ke {David}
    Iya, {Vid}. Itu {jajan}ku. Apa aku sudah boleh pulang ?#speaker:{player} #score: 0 #stress: 0
