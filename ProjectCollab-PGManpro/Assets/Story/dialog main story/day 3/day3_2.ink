...
+melaporkan
    ...
    {David} membully {player} sedikit lalu melepaskan {player} pulang.#speaker:narrator #score: 0 #stress: 20 #blackscreen: 5
    ...
    {David} membully {player} dengan kekerasan fisik#speaker:narrator #score: 0 #stress: 10 #blackscreen: 4
    ++Pukul {David}
